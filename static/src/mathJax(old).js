        ...
        MathJax.Hub = {
            ...
            formatError: function (b, e) {
                ...
                if (MathJax.Extension.MathEvents) {
                    ...
                    MathJax.Ajax.Require("/static/src/extensions/MathEvents.js", function () {
                        c.oncontextmenu = MathJax.Extension.MathEvents.Event.Menu;
                        c.onmousedown = MathJax.Extension.MathEvents.Event.Mousedown
                    })
                }
        ...
        MathJax.Hub.Startup = {
            ...
            MenuZoom: function () {
                if (!MathJax.Extension.MathMenu) {
                    setTimeout(function () {
                        MathJax.Callback.Queue(["Require", MathJax.Ajax, "/static/src/extensions/MathMenu.js", {}], ["loadDomain", MathJax.Localization, "MathMenu"])
                    }, 1000)
                } else {
                    setTimeout(MathJax.Callback(["loadDomain", MathJax.Localization, "MathMenu"]), 1000)
                }
                if (!MathJax.Extension.MathZoom) {
                    setTimeout(MathJax.Callback(["Require", MathJax.Ajax, "/static/src/extensions/MathZoom.js", {}]), 2000)
                }
            },
            onLoad: function () {
