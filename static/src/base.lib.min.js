...
function onUpdateReady() {
    com.zybuluo.common.popupConfirm.popup("新版本通知", '发现新版本， 在这里查看<a href="https://www.zybuluo.com/ghosert/note/102771" target="_blank"> <i class="icon-wrench"></i> 更新详细</a>，点击下方按钮进行更新操作。', function () {
        ...
        $("#notification-popup-window #notification-confirm").html("更新"), $("#notification-popup-window button.close").hide(), $("#notification-popup-window #notification-cancel").hide()
    }, function () {
        window.location.reload()
    })
}
...
!function (a, b) {
    ...
    var N, O, P = a.document, Q = a.location, R = a.navigator, S = a.jQuery, T = a.$, U = Array.prototype.push,
        ...
        }, _ = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source, ab = /\S/, bb = /\s+/,
        cb = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, db = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
        eb = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, fb = /^[\],:{}\s]*$/, gb = /(?:^|:|,)(?:\s*\[)+/g,
        hb = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
        ib = /"[^"\\\r\n]*"|true|false|null|-?(?:\d\d*\.|)\d+(?:[eE][\-+]?\d+|)/g, jb = /^-ms-/, kb = /-([\da-z])/gi,
        lb = function (a, b) {
    ...
    var rb, sb, tb, ub = /[\t\r\n]/g, vb = /\r/g, wb = /^(?:button|input)$/i,
        xb = /^(?:button|input|object|select|textarea)$/i, yb = /^a(?:rea|)$/i,
    ...
    var Bb = /^(?:textarea|input|select)$/i, Cb = /^([^\.]*|)(?:\.(.+)|)$/, Db = /(?:^|\s)hover(\.\S+|)\b/, Eb = /^key/,
        Fb = /^(?:mouse|contextmenu)|click/, Gb = /^(?:focusinfocus|focusoutblur)$/, Hb = function (a) {
    ...
    $.event = {
        ...
        var r, s, t, u, v, w, x, y, z, A, B = !0, C = "undefined", D = ("sizcache" + Math.random()).replace(".", ""),
            ...
            Z = new RegExp("^" + S + "+|((?:^|[^\\\\])(?:\\\\.)*)" + S + "+$", "g"),
            _ = new RegExp("^" + S + "*," + S + "*"), ab = new RegExp("^" + S + "*([\\x20\\t\\r\\n\\f>+~])" + S + "*"),
            bb = new RegExp(X), cb = /^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/, db = /[\x20\t\r\n\f]*[+~]/, eb = /h\d/i,
            fb = /input|select|textarea|button/i, gb = /\\(?!\\)/g, hb = {
                ID: new RegExp("^#(" + T + ")"),
                CLASS: new RegExp("^\\.(" + T + ")"),
    ...
    var Ib = /Until$/, Jb = /^(?:parents|prev(?:Until|All))/, Kb = /^.[^:#\[\.,]*$/, Lb = $.expr.match.needsContext,
    ...
    var Nb = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Ob = / jQuery\d+="(?:null|\d+)"/g, Pb = /^\s+/,
        Qb = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Rb = /<([\w:]+)/,
        Sb = /<tbody/i, Tb = /<|&#?\w+;/, Ub = /<(?:script|style|link)/i, Vb = /<(?:script|object|embed|option|style)/i,
        Wb = new RegExp("<(?:" + Nb + ")[\\s/>]", "i"), Xb = /^(?:checkbox|radio)$/,
        Yb = /checked\s*(?:[^=]|=\s*.checked.)/i, Zb = /\/(java|ecma)script/i,
        $b = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g, _b = {
    ...
    var cc, dc, ec, fc = /alpha\([^)]*\)/i, gc = /opacity=([^)]*)/, hc = /^(top|right|bottom|left)$/,
        ic = /^(none|table(?!-c[ea]).+)/, jc = /^margin/, kc = new RegExp("^(" + _ + ")(.*)$", "i"),
        lc = new RegExp("^(" + _ + ")(?!px)[a-z%]+$", "i"), mc = new RegExp("^([-+])=(" + _ + ")", "i"),
        nc = {BODY: "block"}, oc = {position: "absolute", visibility: "hidden", display: "block"},
        pc = {letterSpacing: 0, fontWeight: 400}, qc = ["Top", "Right", "Bottom", "Left"],
        rc = ["Webkit", "O", "Moz", "ms"], sc = $.fn.toggle;
    $.fn.extend({
        css: function (a, c) {
    ...
    var yc, zc, Ac = /#.*$/, Bc = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Cc = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Dc = /^(?:GET|HEAD)$/, Ec = /^\/\//,
        Fc = /\?/, Gc = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Hc = /([?&])_=[^&]*/,
        Ic = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Jc = $.fn.load, Kc = {}, Lc = {}, Mc = ["*/"] + ["*"];
    try {
        zc = Q.href
    } catch (Nc) {
    ...
    $.ajaxSetup({
        ...
        var f, g, h, i = c.data, j = c.url, k = c.jsonp !== !1, l = k && Qc.test(j),
    ...
    var Vc, Wc, Xc = /^(?:toggle|show|hide)$/, Yc = new RegExp("^(?:([-+])=|)(" + _ + ")([a-z%]*)$", "i"),
        Zc = /queueHooks$/, $c = [J], _c = {
            "*": [function (a, b) {
    ...
    var g, h, i = "placeholder" in b.createElement("input"), j = "placeholder" in b.createElement("textarea"), k = c.fn,
        l = c.valHooks, m = c.propHooks;
    ...
    b.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
            var b, c = a(document).height(), d = this.$window.scrollTop(), e = this.$element.offset(),
                f = this.options.offset, g = f.bottom, h = f.top, i = "affix affix-top affix-bottom";
    ...
    a.fn.dropdownHover = function (d) {
        return "ontouchstart" in document ? this : (c = c.add(this.parent()), this.each(function () {
            var e, f = a(this), g = f.parent(), h = {delay: 500, instantlyCloseOthers: !0},
    ...
    window.PR_SHOULD_USE_CONTINUATION = !0, function () {
        ...
        function k(a) {
            ...
            try {
                ...
                var f = /\bMSIE\s(\d+)/.exec(navigator.userAgent), f = f && +f[1] <= 8, b = /\n/g, g = a.a,
                    h = g.length, d = 0, i = a.d, k = i.length, e = 0, m = a.g, n = m.length, o = 0;
                m[n] = h;
                var p, q;
        ...
        var l = window, m = ["break,continue,do,else,for,if,return,while"],
        ...
        var y = l.PR = {
            ...
            prettyPrint: l.prettyPrint = function (b, c) {
                    ...
                    for (var c = l.PR_SHOULD_USE_CONTINUATION ? o.now() + 250 : 1 / 0; q < i.length && o.now() < c; q++) {
                        ...
                        if (m = f.className, (j !== x || s.test(m)) && !t.test(m)) {
                            ...
                            if (!n) {
                                ...
                                if (u.test(f.tagName)) y = 1; else var y = f.currentStyle, A = g.defaultView,
                ...
                var p, q = 0, r = /\blang(?:uage)?-([\w.]+)(?!\S)/, s = /\bprettyprint\b/, t = /\bprettyprinted\b/,
                    u = /pre|xmp/i, v = /^code$/i, w = /^(?:pre|code|xmp)$/i, x = {};
                d()
            }
        };
...
Namespace.separator = ".", Namespace("com.zybuluo"), com.zybuluo.indexedDB = function () {
    var a = "zybuluoIndexedDB", b = 1, c = "localNoteActions",
        ...
        e = "loginUser", f = ["name", "user_tier"], g = null, h = function (d) {
    ...
    var f, g, h = "=", i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", j = [],
    ...
    var b = $("#notification-popup-window"), c = $("#notification-confirm"), d = $("#notification-cancel"),
        e = $("#notification-title"), f = b.children(".modal-body");
    c.click(function () {
    ...
    var a = $("#global-prompt-alert"), b = $("#close-global-prompt-alert"), c = $("#global-prompt-message"),
